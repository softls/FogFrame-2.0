...
public interface ILocationService {
    ...
    /**
     * Returns the closest neighbor FCN according to the passed location and the location ranges of the fog control nodes
     * in the whole topology.
     * @param latitude location latitude
     * @param longitude location longitude
     * @return closest neighbor FCN
     */
    Fogdevice getClosestNeighborFN(long latitude, long longitude);
     ...
     */
    Fogdevice findClosestDevice(long latitude, long longitude, Set<Fognode> parents);
}
