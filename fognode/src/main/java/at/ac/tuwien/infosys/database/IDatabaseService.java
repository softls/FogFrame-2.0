...
public interface IDatabaseService {
    ...
    int getPort();
    Fogdevice getParent();
    Fogdevice getClosestNeighborFN();
    ...
    long getAverageDeploymentTime();
    long getLastDeploymentTime();
    long getClosestNeighborDelay();
    Set<Long> getChildrenDelays();
    long getCloudDelay();
    ...
    void setClosestNeighborFN(Fogdevice neighbor);
    ...
    void setAverageDeploymentTime(long value);
    void setLastDeploymentTime(long value);
    void setChildrenDelays(Set<Long> values);
    void setClosestNeighborDelay(long value);
    void setCloudDelay(long value);
