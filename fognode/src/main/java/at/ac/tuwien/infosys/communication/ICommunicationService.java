...
public interface ICommunicationService {
    ...
    /**
     * Send request to the closest neighbor stored in the database
     * @param url API url
     * @param method HTTP method (e.g., POST)
     * @param requestEntity wrapper including the entity to send in the request body, null otherwise
     * @param type expected type of the response
     ...
     * @return response of the REST API call on the specified url
     */
    <T> T sendToClosestNeighborFN(String url, HttpMethod method, HttpEntity requestEntity, ParameterizedTypeReference<T> type);
    ...
    /**
     * Sends a pair request to the specified closest neighbor FCN stored in the database.
     * @return a message object with a status that indicates whether it was successful or not
     */
    Message sendPairRequestClosestNeighbor();
     ...
     * @return a message object with a status that indicates whether it was successful or not
     */
    Message sendManualPairRequestClosestNeighbor(Fogdevice fd);
    ...
    /**
     * Requests a closest neighbor at the cloud-fog middleware specified in the local database.
     * @param loc proprietary location
     * @return responsible parent device to pair to
     */
    Fogdevice requestClosestNeighbor(Location loc);
    /**
    ...
    /**
     * Pings the closest neighbor control node
     */
    void pingClosestNeighbor();
    ...
    /**
     * Pair request endpoint method that adds the passed fog device as closest neighbor
     * @param fd new paired child
     * @return message indicating whether the pair was successful or not
     */
    Message pairClosestNeighbor(Fogdevice fd);
