...
public class CommunicationController {
     ...
     * @return a message object with a status that indicates whether it was successful or not
     */
    @RequestMapping(method = RequestMethod.POST, value=Constants.URL_PAIR_REQUEST_CLOSEST_NEIGHBOR)
    public Message pairRequestClosestNeighbor(@RequestBody Fogdevice fogdevice){
        return commService.pairClosestNeighbor(fogdevice);
    }
    ...
    /**
     * Sends a manual pair closest neighbor request to the passed fog device fd.
     * @param fd device to pair to
     * @return a message object with a status that indicates whether it was successful or not
     */
    @RequestMapping(method = RequestMethod.POST, value=Constants.URL_MANUAL_PAIR_REQUEST_CLOSEST_NEIGHBOR)
    public Message manualPairingClosestNeighbor(@RequestBody Fogdevice fd){
        return commService.sendManualPairRequestClosestNeighbor(fd);
    }
