...
public class PropagatorController {
     ...
     * very device is the root device of the topology. If this is the root fn the task requests are extracted of the
    ...
    public void propagate(@RequestBody List<ServiceData> o) {
        ...
        if(parent.getType() != null && parent.getType().equals(DeviceType.FOG_CONTROLLER) && s != null && s.isReasoningPurpose()){
