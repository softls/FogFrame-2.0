...
public class Constants {
    ...
    public static final String IP_HOST = "192.168.1.187";
    public static final String IP_CLOUD = IP_HOST;
    public static final String IP_FN1 = "192.168.1.105";
    public static final String IP_FN2 = "192.168.1.106";
    public static final String IP_FN3 = "192.168.1.107";
    ...
    public static final int PORT_FOG_CONTROLLER = 8082;
    public static final int PORT_FC = 8081;
    public static final int PORT_FN = 8080;
    ...
    public static final String URL_DB_AVERAGE_DEPLOYMENT_TIME=URL_DB+"averageDeploymentTime";
    public static final String URL_DB_LAST_DEPLOYMENT_TIME=URL_DB+"lastDeploymentTime";
    public static final String URL_DB_CHILDREN_DELAYS=URL_DB+"childrenDelays";
    public static final String URL_DB_CLOSEST_NEIGHBOR_DELAY=URL_DB+"closestNeighborDelay";
    public static final String URL_DB_CLOUD_DELAY=URL_DB+"cloudDelay";
    ...
    public static final String URL_PAIR_REQUEST_CLOSEST_NEIGHBOR=URL_COMMUNICATION+"pairRequestClosestNeighbor/";
    public static final String URL_MANUAL_PAIR_REQUEST = URL_COMMUNICATION + "manualPair";
    public static final String URL_MANUAL_PAIR_REQUEST_CLOSEST_NEIGHBOR=URL_COMMUNICATION+"manualPairClosestNeighbor";
    ...
    public static final String URL_REQUEST_CLOSEST_NEIGHBOR=URL_LOCATOR+"closestFCN/";
